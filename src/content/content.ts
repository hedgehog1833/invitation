...
export const accommodationContent: AccomodationContent[] = [
  {
    ...
    links: [
      {
        title: "Gasthaus am Hochsimmer - Ettringen, Fahrtzeit ca. 10 Minuten",
      ...
      {
        title: "Zum Anker - Langenfeld, Fahrtzeit ca. 15 Minuten",
      ...
      {
        title: "Landhaus Kürrenberg - Kürrenberg, Fahrtzeit ca. 15 Minuten",
  ...
  },
  {
    ...
    links: [
      {
        title: "Gutshof Hotel Arosa - Ochtendung, Fahrtzeit ca. 20 Minuten",
