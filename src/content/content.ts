...
export const accommodationContent: AccomodationContent[] = [
  {
    ...
    links: [
      {
        title: "Gasthaus am Hochsimmer (Ettringen)",
      ...
      {
        title: "Landhaus Kürrenberg (Kürrenberg)",
  ...
  {
    header: "Hotels, Fahrtzeit ca. 20 Minuten",
    links: [
      {
        title: "Gutshof Hotel Arosa (Ochtendung)",
        url: "https://www.gutshofhotelarosa.de/index.php/de/zimmer",
      },
      {
        title: "Parkhotel am Schloss (Ettringen)",
        url: "https://www.parkhotel-am-schloss.de/preise-2025.html",
      },
    ],
  },
  {
    header: "Gehobeneres Hotel, Fahrtzeit ca. 30 Minuten",
    links: [
      {
        title: "Purs - Am Ochsentor (Andernach)",
